 ...
 *
 * Example:
 *   ./test_connect -myindex 2 -list mlx-stud-01 mlx-stud-02 mlx-stud-03 mlx-stud-04
 *
...
static int test_all_reduce(pg_handle_t process_group, int process_rank, int num_processes) {
    ...
    // Perform all-reduce
    int result = pg_all_reduce(process_group,
                              send_data,
                              recv_data,
                              TEST_DATA_SIZE,
                              PG_DATATYPE_DOUBLE,
...
static int test_reduce_scatter(pg_handle_t process_group, int process_rank, int num_processes) {
    ...
    int result = pg_reduce_scatter(process_group,
                                  send_data,
                                  recv_data,
                                  TEST_DATA_SIZE,
                                  PG_DATATYPE_DOUBLE,
...
static int test_all_gather(pg_handle_t process_group, int process_rank, int num_processes) {
    ...
    // Perform all-gather
    int result = pg_all_gather(process_group,
                              send_data,
                              recv_data,
                              TEST_DATA_SIZE,
                              PG_DATATYPE_DOUBLE);
