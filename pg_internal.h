 ...
 */
static inline void pg_apply_reduction_operation(void* destination_buffer, 
                                               void* source_buffer_1, 
                                               void* source_buffer_2, 
                                               int element_count,
                                               pg_datatype_t data_type, 
                                               pg_operation_t operation) {
 ...
 */
static inline void pg_calculate_ring_neighbors(int current_rank, 
                                              int group_size,
 ...
 */
static inline void pg_calculate_data_chunk_boundaries(int process_rank, 
                                                     int group_size,
                                                     int total_elements, 
                                                     size_t element_size,
                                                     size_t *chunk_offset, 
